%% CWSNN on Liver dataset %% 
clear
close all
clc

%%% Read and process the dataset %%%
liver_disorders = load('liver_disorders.txt');
Liver = liver_disorders(:,1:6);

%%% Parameter settings %%%
C = 2;                             % the number of class
SampleNum = size(Liver,1);         % the number of samples
F = size(Liver,2);                 % the number of features
