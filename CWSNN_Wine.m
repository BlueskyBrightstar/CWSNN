...
Winex = Wine_data_numerical(:,1:13);

%%% Parameter settings %%%
C = 3;                             % the number of class
SampleNum = size(Winex,1);         % the number of samples
F = size(Winex,2);                 % the number of features
